...
function updateTracker() {
    const totalCorrect = tracker.roman.correct + tracker.english.correct + tracker.devanagari.correct;
    const totalIncorrect = tracker.roman.incorrect + tracker.english.incorrect + tracker.devanagari.incorrect;
    ...
    document.querySelector('.tracker-container').innerHTML = `
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="lang-col">Roman:</td>
                    <td class="score-col correct-col"><span style="color:#4ade80">${tracker.roman.correct}</span></td>
                    <td class="score-col incorrect-col"><span style="color:#f87171">${tracker.roman.incorrect}</span></td>
                    <td>${calcPercent(tracker.roman.correct, tracker.roman.incorrect)}%</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="lang-col">देवनागरी:</td>
                    <td class="score-col correct-col"><span style="color:#4ade80">${tracker.devanagari.correct}</span></td>
                    <td class="score-col incorrect-col"><span style="color:#f87171">${tracker.devanagari.incorrect}</span></td>
                    <td>${calcPercent(tracker.devanagari.correct, tracker.devanagari.incorrect)}%</td>
                </tr>
            </tbody>
        </table>
    `;
    ...
    options.forEach(opt => {
        ...
        btn.addEventListener('click', () => {
            ...
            if (opt === correctAnswer) {
                ...
                // --- ONLY DISABLE OTHER BUTTONS WHEN CORRECT ---
